...
public class K {
    ...
    public static class ErrorMessageInfo {
        public static final String EMAIL_ALREADY_TAKEN_INFO = "This email is already taken.";
        public static final String PHONE_ALREADY_USING = "This phone number is already using another.";
        public static final String USER_NOT_FOUND_INFO = "User not found with ";
        public static final String UNKNOWN_ERROR_INFO = "An unknown error.";
        public static final String USERNAME_OR_PASSWORD_WRONG_INFO = "Email or password is wrong";
